...
public class Topic_03_WebBrowser_WebElement {
  ...
  public void f() {
	  /*------- WEB BROWSER --------*/
		...
		//test giao dieekn
		/*
		driver.manage().window().setSize(new Dimension(1024, 768)); //chiều dài và rộng của browser
		driver.manage().window().setPosition(new Point(300, 300)); // khoảng cách browser so vo màn hình máy tính
  ...
  @Test
	public void TC_02_WebElement() {
		...
		java.util.List<WebElement> homePageLink = driver.findElements(By.xpath("//a"));
